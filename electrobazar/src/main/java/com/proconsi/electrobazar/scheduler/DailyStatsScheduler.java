...
public class DailyStatsScheduler {
  ...
  private void checkSchema() {
    try {
      ...
      jdbcTemplate
          .execute("ALTER TABLE daily_sales_stats ADD COLUMN IF NOT EXISTS returns_total DECIMAL(15,2) DEFAULT 0.00");
      ...
      jdbcTemplate
          .execute("ALTER TABLE monthly_sales_stats ADD COLUMN IF NOT EXISTS returns_total DECIMAL(15,2) DEFAULT 0.00");
    } catch (Exception e) {
