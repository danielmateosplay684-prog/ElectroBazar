    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/cash-registers/**").hasAnyAuthority("CASH_REGISTER", "CASH_CLOSE", "ADMIN_ACCESS")
                .requestMatchers("/api/cash-withdrawals/**").hasAnyAuthority("CASH_REGISTER", "CASH_CLOSE", "ADMIN_ACCESS")
