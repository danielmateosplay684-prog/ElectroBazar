...
class PromotionServiceTest {
    ...
    void testPromo3x2SixUnits() {
        ...
        PromotionCalcRequest request = PromotionCalcRequest.builder()
                .lines(Arrays.asList(
                        PromotionCalcRequest.Line.builder().productId(1L).quantity(new BigDecimal("6")).build()
                ))
                .build();
    ...
    void testPromo3x2NineUnits() {
        ...
        PromotionCalcRequest request = PromotionCalcRequest.builder()
                .lines(Arrays.asList(
                        PromotionCalcRequest.Line.builder().productId(1L).quantity(new BigDecimal("9")).build()
                ))
                .build();
    ...
    void testPromo3x2WeightProduct() {
        ...
        PromotionCalcRequest request = PromotionCalcRequest.builder()
                .lines(Arrays.asList(
                        PromotionCalcRequest.Line.builder().productId(2L).quantity(new BigDecimal("1.500")).build()
                ))
                .build();
    ...
    void testPromo3x2UnderLimit() {
        ...
        PromotionCalcRequest request = PromotionCalcRequest.builder()
                .lines(Arrays.asList(
                        PromotionCalcRequest.Line.builder().productId(1L).quantity(new BigDecimal("2")).build()
                ))
                .build();
